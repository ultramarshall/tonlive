<!-- Footer -->
<footer class="footer py-7 bg-primary text-white " style="border-top:5px solid #008ED1">
        <div class="container">
          <div class="row gap-y">
...
<!-- /.footer --><?php /**PATH /Users/marshall/Documents/worktrees/tonworktrees/public_html/resources/views/layout/_footer.blade.php ENDPATH**/ ?>