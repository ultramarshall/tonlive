<div class="row">
    <div class="col-md-6 float-left">
        <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm" name="id" id="id" value="<?php echo e($vendor->id); ?>">
        </div>
        <div class="form-group">
...
</script><?php /**PATH /Users/marshall/Documents/worktrees/tonworktrees/public_html/Modules/MyaccountPartnerModule/Providers/../Resources/views/pages/identitas.blade.php ENDPATH**/ ?>