...
$(document).ready( function () {
    $('#eproclistsGeneral').DataTable();
    $('#eproclistsPartner').DataTable();
} );
</script>
<?php $__env->stopSection(); ?>
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class=" col-lg-12 shadow-5 bg-white p-5 pt-1 rounded  order-first order-md-first">
                        <h5 class="tender">Pengadaan umum</h5>
                        <hr class="mt-1 mb-5" />
                        <table id="eproclistsGeneral" class="table display">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Pengadaan aplikasi e-procurement</td>
                                    <td>Rp 340.000.000</td>
                                    <td>20-12-2019</td>
                                    <td>
                                        <a  href="/eproc/detail-procurement/1" class="btn btn-primary btn-sm">Detail</a>
                                    </td>
                ...
                <div class="row mt-5">
                    <div class="col-lg-12 shadow-5 bg-white p-5 pt-1 rounded  order-first order-md-first">
                        <h5 class="tender">Pengadaan Tender</h5>
                        <hr class="mt-1 mb-5" />
                        <table id="eproclistsPartner" class="table display ">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>nama Paket</th>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/marshall/Desktop/ton/public_html/Modules/EporcModule/Providers/../Resources/views/index.blade.php ENDPATH**/ ?>