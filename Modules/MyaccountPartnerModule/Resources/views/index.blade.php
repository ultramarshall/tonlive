            ...
            <div class="col-md-8  offset-lg-1 shadow-5 col-xl-8 bg-white p-4 pb-8 pt-5 rounded  order-first order-md-first">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card text-white shadow-4 justify-content-end bg-img" style="background-image: url({{asset('images/companyAssets/slider1.jpg')}});" data-scrim-bottom=10>
                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="card text-white shadow-4 justify-content-end bg-img" style="background-image: url({{asset('images/companyAssets/slider2.jpg')}});" data-scrim-bottom=10>
